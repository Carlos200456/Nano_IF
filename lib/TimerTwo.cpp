...
extern TimerTwo Timer2;              // preinstatiate

//initialise private variables
unsigned long TimerTwo::cycles=0;
uint8_t TimerTwo::tcnt2_init=0;
uint8_t TimerTwo::clockSelectBits=0;
uint8_t *TimerTwo::pwm_arr;
...
void TimerTwo::EnableTimerInterrupt(void (*isr)(), unsigned long microseconds)
{
  if(microseconds > 0){
...
uint8_t TimerTwo::EnablePWM(uint8_t pin,unsigned long microseconds,uint8_t duty)
{	
